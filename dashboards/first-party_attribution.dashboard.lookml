...
- dashboard: firstparty_micromoment_attribution_dashboard
  ...
  - type: button
    name: button_827
    rich_content_json: '{"text":"Advocado® Attribution Methodology","description":"","newTab":true,"alignment":"right","size":"large","style":"FILLED","color":"#78b34d","href":"https://drive.google.com/file/d/1ZagNrso_1z9dKye1fOb-0NRYpYMvLSDP/view?usp=drive_link"}'
    row: 20
    col: 16
    width: 8
    height: 1
  - type: button
    name: button_828
    rich_content_json: '{"text":"Key Terms","description":"","newTab":true,"alignment":"right","size":"large","style":"FILLED","color":"#4d2987","href":"https://docs.google.com/document/d/1g7sDRf1guudKUd700WDGDbMkQE6UErh3ALNn2NeDIDQ/edit?usp=sharing"}'
    row: 21
    col: 16
    width: 8
    height: 1
