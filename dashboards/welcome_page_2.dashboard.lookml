---
- dashboard: welcome_to_insights_power_
  ...
  - name: ''
    ...
    body_text: '[{"type":"h1","children":[{"text":"Dashboard Navigation:","color":"hsl(0,
      ...
      {"type":"h3","align":"start","children":[{"text":"","color":"hsl(0, 0%, 11%)"}],"id":1702409541255},{"type":"p","children":[{"text":"","fontSize":"14px","backgroundColor":"rgb(255, 255, 255)","color":"hsl(0,
  ...
  - title: Untitled
    ...
    type: looker_grid
    fields: [lift_attribution.welcome_dash_brand_links_limited]
    filters:
      lift_attribution.local_start_date_filter: 30 days
    sorts: [lift_attribution.welcome_dash_brand_links_limited]
    limit: 500
    column_limit: 50
